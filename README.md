...
2. Feature Prioritization (Kanban Board)  
...
-why are my Image URLss not working and why is the image broken
...
What I rejected:
-In the ProductsController it gave me names and details that didnt match my personas So i went in peronsally and made sure each item matched each persona and what they would sell. 
-rejected some of the image suggestions because they were random and didnt match the products.
